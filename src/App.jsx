...
//           <img src="https://raw.githubusercontent.com/CodeCr4cker/Required-Document/main/about/about.jpg" alt="Divyanshu Pandey" className="w-24 h-24 rounded-full object-cover"/>
//         </div>
...
// const AboutUs = ({ onClose, canEdit, about, setAbout, logoUrl, setLogoUrl, onContact, devAccount }) => {
//   const [edit, setEdit] = useState(false);
//   const [localAbout, setLocalAbout] = useState(about || "");
//   const [localLogo, setLocalLogo] = useState(logoUrl || "");
//   useEffect(() => { setLocalAbout(about); setLocalLogo(logoUrl); }, [about, logoUrl]);
//   return (
//     <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50">
//       <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full relative shadow-2xl">
//         <button className="absolute top-2 right-2" onClick={onClose}>✖</button>
//         <div className="w-24 h-24 rounded-full mx-auto mb-2 bg-blue-100 flex items-center justify-center overflow-hidden border-4 border-blue-400">
//           <img src={localLogo || "https://raw.githubusercontent.com/CodeCr4cker/Required-Document/main/about/about.jpg"} alt="Logo" className="w-24 h-24 rounded-full object-cover"/>
//         </div>
//         <h3 className="text-center font-bold text-lg mb-1 flex items-center justify-center gap-2">
//           <span className="text-green-500">●</span> Divyanshu-Pandey
//         </h3>
...
//                 className="w-full mb-2 p-2 border dark:border-gray-600 rounded"
//               />
//             )}
//             <div className="flex gap-2">
//               <button className="flex-1 bg-blue-500 text-white rounded py-1" onClick={() => { setAbout(localAbout); setLogoUrl(localLogo); setEdit(false); }}>Save</button>
//               <button className="flex-1 bg-gray-300 text-gray-800 rounded py-1" onClick={() => setEdit(false)}>Cancel</button>
//             </div>
//           </>
//         ) : (
...
const AboutUs = ({ onClose, canEdit, about, setAbout, onContact, devAccount, logoURL, setLogoURL, aboutPhotoURL, setAboutPhotoURL }) => {
  const [edit, setEdit] = useState(false);
  const [localAbout, setLocalAbout] = useState(about || "");
...
const NotificationPopup = ({ currentUser }) => {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snap) => {
      if (!snap.empty) {
        const n = snap.docs[snap.docs.length - 1].data();
        setNotification(n);
